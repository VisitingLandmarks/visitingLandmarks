...
const RouteDefinition = ({store}) => (
    <div id="router">
        ...
        <LoggedInRoute path={routes.user.passwordChange} store={store} component={DialogChangePassword}/>
        ...
        <LoggedOutRoute path={routes.user.resetPassword} store={store} component={DialogResetPassword}/>
    </div>
);
